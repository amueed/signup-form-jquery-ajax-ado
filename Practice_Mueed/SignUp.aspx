        ...
        <div>
            <table align="center">
                ...
                <tr>
                    <td>First Name</td>
                    <td>
                        <input type="text" id="txtFname" name="txtFname" class="normal" /></td>
                </tr>
                <tr>
                    <td>Last Name</td>
                    <td>
                ...
                <tr>
                    <td>Address</td>
                    <td>
                        <input type="text" id="txtAddress" name="txtAddress" /></td>
                </tr>
                <tr>
                    <td>Email</td>
                    <td>
                ...
                <tr>
                    <td>Username</td>
                    <td>
                        <input type="text" id="txtUsername" name="txtUsername" onblur="checkUser();" /></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="txtCPassword" name="txtCPassword" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <input type="submit" id="btnSubmit" value="Submit" onclick="return Insert();" /></td>
                </tr>
            </table>
            <div id="errorBox"></div>
            <br />
